...
=== 요구사항 ===
0. 명령어는 실행 순서대로 제시하세요 명령어1, 명령어2 = 명령어1번 실행 후 명령어2 실행
...
예시)
1.
[ls -al , cat ./- , grep "password" flag.txt]
시스템 파일 구조를 파악하고 중요한 파일을 찾기
/etc/passwd 파일을 통해 사용자 정보를 확인할 수 있음

2.
[whoami , chmod 777 flag/ test.txt , cat flag/ test.txt]
